...
angular.module("RdmApp").filter("filterSiswa",(function(){return function(a,e){var t=[];return void 0===e||""===e||angular.forEach(a,(function(a){a.rombel===e&&t.push(a)})),t}})),angular.module("RdmApp").controller("cetakraporraCtrl",["$scope","$rootScope","common","DTOptionsBuilder","DTColumnBuilder","$http","$q","ApiServer","FileUploader",function(a,e,t,s,l,i,o,n,r){a.dtInstance={},a.dataEdit={},e.walassiswa={},a.reloadTable=function(){e.walassiswa={},""!==a.selectData.kelas_id&&($.blockUI({}),n.post("proktor/siswa/datasiswa",a.selectData,(function(a){$.unblockUI({}),e.walassiswa=a.data})))},a.selectData={},a.selectData.kelas_id="",a.selectData.tingkat_id="",a.dtOptions=s.newOptions().withOption("searching",!0).withButtons([{extend:"copy",text:'<i class="fa fa-files-o"></i> Copy',titleAttr:"Copy"},{extend:"pdfHtml5",text:'<i class="fa fa-print" aria-hidden="true"></i> Print',download:"open",exportOptions:{columns:[0,2,3,4,5,6]},titleAttr:"Print",customize:function(a){e.customepdf(a,"Data Siswa","RDM")}},{extend:"excelHtml5",text:'<i class="fa fa-file-text-o"></i> Excel',exportOptions:{columns:[0,2,3,4,5,6]},titleAttr:"Excel"}]).withOption("columnDefs",[{responsivePriority:1,targets:-1},{responsivePriority:2,targets:4},{responsivePriority:3,targets:2},{responsivePriority:4,targets:3}]).withOption("responsive",!0).withOption("paging",!0).withOption("stateSave",!0).withOption("processing",!0).withOption("drawCallback",(function(){$(".lazy").Lazy();try{a.$apply()}catch(a){}})).withPaginationType("full_numbers"),a.cetakAllNilai=function(t,s){console.log(t),console.log(e.walassiswa.length),t<e.walassiswa.length?($.blockUI({message:"Proses generate nilai "+e.walassiswa[t].siswa_nama+", <br> Proses data "+Math.round(100*(t+1)/e.walassiswa.length)+"% ("+(t+1)+" dari "+e.walassiswa.length+" siswa)."}),n.get("cetak/raporra/gennilaipdf/"+a.selectData.kelas_id+"/"+e.walassiswa[t].siswa_id,(function(e){$.unblockUI({}),e.success?a.cetakAllNilai(t+1,0):s>2?Swal.fire({type:"error",title:"Gagal",showConfirmButton:!1,html:"Gagal generate nilai",timer:2e3}):a.cetakAllNilai(t,s+1)}))):a.openNewAjaxTab("cetak/raporra/downnilaipdf/"+a.selectData.kelas_id)},a.cetakAllRapor=function(t,s){console.log(t),console.log(e.walassiswa.length),0==e.walassiswa.length||(t<e.walassiswa.length?($.blockUI({message:"Proses generate rapor "+e.walassiswa[t].siswa_nama+", <br> Proses data "+Math.round(100*(t+1)/e.walassiswa.length)+"% ("+(t+1)+" dari "+e.walassiswa.length+" siswa)."}),n.get("cetak/raporra/genraporpdf/"+a.selectData.kelas_id+"/"+e.walassiswa[t].siswa_id,(function(e){$.unblockUI({}),e.success?a.cetakAllRapor(t+1,0):s>2?Swal.fire({type:"error",title:"Gagal",showConfirmButton:!1,html:"Gagal generate rapor",timer:2e3}):a.cetakAllRapor(t,s+1)}))):a.openNewAjaxTab("cetak/raporra/downraporpdf/"+a.selectData.kelas_id))},a.cetakAllSampul=function(t,s){console.log(t),console.log(e.walassiswa.length),0==e.walassiswa.length||(t<e.walassiswa.length?($.blockUI({message:"Proses generate sampul "+e.walassiswa[t].siswa_nama+", <br> Proses data "+Math.round(100*(t+1)/e.walassiswa.length)+"% ("+(t+1)+" dari "+e.walassiswa.length+" siswa)."}),n.get("cetak/raporra/gensampulsiswapdf/"+a.selectData.kelas_id+"/"+e.walassiswa[t].siswa_id,(function(e){$.unblockUI({}),e.success?a.cetakAllSampul(t+1,0):s>2?Swal.fire({type:"error",title:"Gagal",showConfirmButton:!1,html:"Gagal generate sampul",timer:2e3}):a.cetakAllSampul(t,s+1)}))):a.openNewAjaxTab("cetak/raporra/downsampulpdf/"+a.selectData.kelas_id))},a.cetakAllIdentitas=function(t,s){console.log(t),console.log(e.walassiswa.length),0==e.walassiswa.length||(t<e.walassiswa.length?($.blockUI({message:"Proses generate identitas "+e.walassiswa[t].siswa_nama+", <br> Proses data "+Math.round(100*(t+1)/e.walassiswa.length)+"% ("+(t+1)+" dari "+e.walassiswa.length+" siswa)."}),n.get("cetak/raporra/genidentitassiswapdf/"+a.selectData.kelas_id+"/"+e.walassiswa[t].siswa_id,(function(e){$.unblockUI({}),e.success?a.cetakAllIdentitas(t+1,0):s>2?Swal.fire({type:"error",title:"Gagal",showConfirmButton:!1,html:"Gagal generate identitas",timer:2e3}):a.cetakAllIdentitas(t,s+1)}))):a.openNewAjaxTab("cetak/raporra/downidentitaspdf/"+a.selectData.kelas_id))},a.openNewAjaxTab=function(a){$.ajax({url:base_url+"cetak/raporra/validasi",method:"GET",headers:{"Content-type":"application/json"},responseType:"arraybuffer",success:function(e){var t,s=new XMLHttpRequest;s.open("GET",a,!0),s.responseType="arraybuffer",s.onload=function(a){t=new Blob([this.response])},s.onprogress=function(a){},s.onloadend=function(e){var s=document.createElement("a");document.body.appendChild(s),s.style="display: none",a=window.URL.createObjectURL(t),s.href=a,s.download="Download.pdf",s.click(),window.URL.revokeObjectURL(a)},s.send()},error:function(a){Swal.fire({type:"error",title:"Gagal",showConfirmButton:!1,html:"Gagal download",timer:2e3})}})}}]);
...
angular.module("RdmApp").controller("kirimnilaiCtrl",["$scope","$rootScope","common","DTOptionsBuilder","DTColumnBuilder","$http","$q","ApiServer","ApiPusat","FileUploader","$compile",function(a,t,i,e,l,n,o,s,r,m,u){a.dtInstance={},a.tabelData={},a.dtColumns=[l.newColumn("no").withTitle("#").notSortable(),l.newColumn("nama_kelas").withTitle("Kelas"),l.newColumn("walikelas").withTitle("Wali Kelas").notSortable(),l.newColumn("jurusan_nama").withTitle("Jurusan").notSortable(),l.newColumn("semester_nama").withTitle("Semester").notSortable(),l.newColumn("persenkirim").withTitle("Persentase Nilai").notSortable(),l.newColumn("siswajml").withTitle("Jumlah Siswa").notSortable(),l.newColumn(null).withTitle("Aksi").notSortable().renderWith((function(t,i,e,l){var n="";3==a.tabelData[l.row].nilailock?n='<div class="btn-group m-1" role="group" aria-label="Basic example"><button class="btn btn-sm btn-danger" type="button" ng-click="dobatalKirim('+l.row+')"> <i class="c-icon fa fa-ban"></i> <span class="d-md-down-none">Batal Kirim</span> </button>':100!=a.tabelData[l.row].persenkirim&&2!=a.tabelData[l.row].nilailock||(n='<div class="btn-group m-1" role="group" aria-label="Basic example"><button class="btn btn-sm btn-success" type="button" ng-click="dodataKirim('+l.row+')"> <i class="c-icon fa fa-send"></i> <span class="d-md-down-none">Kirim</span> </button>');return n}))],a.dtOptions=e.newOptions().withOption("ajax",(function(t,i,e){console.log(t),$(".table-responsive").block({message:'<i class="fa fa-spinner fa-spin"></i>'}),s.post("proktor/kirimnilai/data",t,(function(t){$(".table-responsive").unblock({}),console.log(t),a.tabelData=t.results.data,i({recordsTotal:t.results.recordsTotal,recordsFiltered:t.results.recordsFiltered,data:t.results.data})}))})).withOption("language",{paginate:{first:"<i class='fa fa-fast-backward'></i>",previous:"<i class='fa fa-step-backward'></i>",next:"<i class='fa fa-step-forward'></i>",last:"<i class='fa fa-fast-forward'></i>|"}}).withDataProp("data").withDOM("lBfrtip").withOption("searching",!0).withButtons([{extend:"copy",text:'<i class="fa fa-files-o"></i> Copy',titleAttr:"Copy"},{extend:"pdfHtml5",text:'<i class="fa fa-print" aria-hidden="true"></i> PDF',download:"open",exportOptions:{columns:[0,1,2,3,4,5,6]},titleAttr:"Print",customize:function(a){t.customepdf(a,"Data Lembaga","Pangkalan Data AKMI")}},{extend:"excelHtml5",text:'<i class="fa fa-file-text-o"></i> Excel',exportOptions:{columns:[0,1,2,3,4,5,6]},titleAttr:"Excel"}]).withOption("drawCallback",(function(t){if(a.currPg=0,t.aoData.length>0){var i=this.api().page.info();console.log(i),a.currPg=i}})).withOption("columnDefs",[{responsivePriority:1,targets:0},{responsivePriority:2,targets:-1},{responsivePriority:3,targets:-2},{responsivePriority:4,targets:-3}]).withOption("responsive",!0).withDisplayLength(10).withOption("lengthMenu",[[10,25,50,100,-1],[10,25,50,100,"All"]]).withOption("stateSave",!0).withOption("paging",!0).withOption("processing",!0).withOption("serverSide",!0).withOption("aaSorting",[0,"asc"]).withOption("createdRow",(function(t){u(angular.element(t).contents())(a)})).withPaginationType("full_numbers"),a.reloadTable=function(){$("#aktifTable").DataTable().ajax.reload(null,!1)},a.kirimsemuanilai=function(){Swal.fire({type:"warning",title:"Perhatian",confirmButtonText:"Ya, kirim!",showCancelButton:!0,html:"Apakah Anda yakin akan mengirim semua nilai kelas yang belum terkirim?"}).then((t=>{t.value&&($.blockUI({message:"Mengechek data nilai kelas yang belum terkirim"}),s.get("proktor/kirimnilai/getkirimkelas",(function(t){t.success?(a.dataKirimKelas=t.data,console.log(a.dataKirimKelas),a.doKirimKelas(0)):(a.reloadTable(),$.unblockUI({}),Swal.fire({type:"error",title:"Gagal",showConfirmButton:!0,html:t.message}))})))}))},a.doKirimKelas=function(t){t<a.dataKirimKelas.length?(a.datakirim=a.dataKirimKelas[t],$.blockUI({message:"Menyiapkan data nilai kelas "+a.dataKirimKelas[t].nama_kelas}),s.post("proktor/kirimnilai/prepare",a.dataKirimKelas[t],(function(i){i.success?(a.dataPusat=i.data,a.doKirimBulk1(t,0)):(a.reloadTable(),$.unblockUI({}),Swal.fire({type:"error",title:"Gagal",showConfirmButton:!0,html:i.message}))}))):($.unblockUI({}),Swal.fire({type:"success",title:"Berhasil",showConfirmButton:!1,html:"Data Nilai kelas berhasil dikirim",timer:2e3}))},a.doKirimBulk1=function(t,i){$.blockUI({message:"Mengirim data rapor kelas "+a.datakirim.nama_kelas+" ke pusat"}),r.post("kirimnilaibulk",a.dataPusat,(function(e){e.success?0==e.gagal?($.unblockUI({}),a.bulkdataDone1(t)):($.unblockUI({}),Swal.fire({type:"error",title:"Gagal",showConfirmButton:!0,html:"Terdapat "+e.failed+" nilai yang gagal disimpan."})):e.success?i<3?a.doKirimBulk1(t,i+1):(a.persen="",$.unblockUI({}),Swal.fire({type:"error",title:"Gagal",showConfirmButton:!0,html:"Gagal Mengirim Nilai"})):(a.persen="",$.unblockUI({}),Swal.fire({type:"error",title:"Gagal",showConfirmButton:!0,html:e.message}))}))},a.bulkdataDone1=function(t){$.blockUI({message:"Update data nilai kelas "+a.datakirim.nama_kelas}),s.post("proktor/kirimnilai/done",a.datakirim,(function(i){i.success?($.unblockUI({}),a.reloadTable(),a.doKirimKelas(t+1)):($.unblockUI({}),Swal.fire({type:"error",title:"Gagal",showConfirmButton:!0,html:i.message}))}))},a.doKirimPusat1=function(t,i,e){i<a.dataPusat.length?(a.persen=Math.round(100*(i+1)/a.dataPusat.length),$.blockUI({message:"Mengirim data rapor "+a.dataPusat[i].siswa.siswa_nama+" ke pusat"}),r.post("kirimnilai",a.dataPusat[i],(function(l){l.success?a.doKirimPusat1(t,i+1,0):l.success?e<3?a.doKirimPusat1(t,i,e+1):(a.persen="",$.unblockUI({}),Swal.fire({type:"error",title:"Gagal",showConfirmButton:!0,html:"Gagal Mengirim Nilai"})):(a.persen="",$.unblockUI({}),Swal.fire({type:"error",title:"Gagal",showConfirmButton:!0,html:l.message}))}))):(a.persen="",$.unblockUI({}),a.dodataDone1(t))},a.dodataDone1=function(t){$.blockUI({message:"Update data nilai kelas "+a.datakirim.nama_kelas}),s.post("proktor/kirimnilai/done",a.datakirim,(function(i){i.success?($.unblockUI({}),a.reloadTable(),a.doKirimKelas(t+1)):($.unblockUI({}),Swal.fire({type:"error",title:"Gagal",showConfirmButton:!0,html:i.message}))}))},a.dataKirimKelas=[],a.dodataKirim=function(t){Swal.fire({type:"warning",title:"Perhatian",confirmButtonText:"Ya, kirim!",showCancelButton:!0,html:"Apakah Anda yakin akan mengirim data kelas "+a.tabelData[t].nama_kelas+"?"}).then((i=>{i.value&&(a.datakirim=a.tabelData[t],$.blockUI({message:"Menyiapkan data nilai kelas "+a.tabelData[t].nama_kelas}),s.post("proktor/kirimnilai/prepare",a.tabelData[t],(function(t){t.success?(a.dataPusat=t.data,a.doKirimPusat(0,0)):(a.reloadTable(),$.unblockUI({}),Swal.fire({type:"error",title:"Gagal",showConfirmButton:!0,html:t.message}))})))}))},a.dobatalKirim=function(t){Swal.fire({type:"warning",title:"Perhatian",confirmButtonText:"Ya, Batalkan!",showCancelButton:!0,html:"Apakah Anda yakin akan membatalkan pengiriman data kelas "+a.tabelData[t].nama_kelas+"?"}).then((i=>{i.value&&(a.datakirim=a.tabelData[t],$.blockUI({message:"Mengecek status pengiriman kelas "+a.tabelData[t].nama_kelas}),s.post("proktor/kirimnilai/batalkirim",a.tabelData[t],(function(t){$.unblockUI({}),t.success?(a.reloadTable(),Swal.fire({type:"success",title:"Berhasil",showConfirmButton:!1,html:"Pengiriman nilai berhasil dibatalkan",timer:2e3})):(a.reloadTable(),Swal.fire({type:"error",title:"Gagal",showConfirmButton:!0,html:t.message}))})))}))},a.datakirim={},a.persen="",a.doKirimBulk=function(t){$.blockUI({message:"Mengirim data rapor kelas "+a.datakirim.nama_kelas+" ke pusat"}),r.post("kirimnilaibulk",a.dataPusat,(function(i){i.success?0==i.gagal?($.unblockUI({}),a.bulkdataDone(i)):($.unblockUI({}),Swal.fire({type:"error",title:"Gagal",showConfirmButton:!0,html:"Terdapat "+i.failed+" nilai yang gagal disimpan."})):i.success?t<3?a.doKirimBulk(t+1):(a.persen="",$.unblockUI({}),Swal.fire({type:"error",title:"Gagal",showConfirmButton:!0,html:"Gagal Mengirim Nilai"})):(a.persen="",$.unblockUI({}),Swal.fire({type:"error",title:"Gagal",showConfirmButton:!0,html:i.message}))}))},a.bulkdataDone=function(t){$.blockUI({message:"Update data nilai kelas "+a.datakirim.nama_kelas}),s.post("proktor/kirimnilai/done",a.datakirim,(function(i){i.success?($.unblockUI({}),a.reloadTable(),Swal.fire({type:"success",title:"Berhasil",showConfirmButton:!0,html:"Data Nilai kelas "+a.datakirim.nama_kelas+" berhasil dikirim<br>   Total data:"+t.berhasil})):($.unblockUI({}),Swal.fire({type:"error",title:"Gagal",showConfirmButton:!0,html:i.message}))}))},a.doKirimPusat=function(t,i){t<a.dataPusat.length?(a.persen=Math.round(100*(t+1)/a.dataPusat.length),$.blockUI({message:"Mengirim data rapor "+a.dataPusat[t].siswa.siswa_nama+" ke pusat"}),r.post("kirimnilai",a.dataPusat[t],(function(e){e.success?a.doKirimPusat(t+1,0):e.success?i<3?a.doKirimPusat(t,i+1):(a.persen="",$.unblockUI({}),Swal.fire({type:"error",title:"Gagal",showConfirmButton:!0,html:"Gagal Mengirim Nilai"})):(a.persen="",$.unblockUI({}),Swal.fire({type:"error",title:"Gagal",showConfirmButton:!0,html:e.message}))}))):(a.persen="",$.unblockUI({}),a.dodataDone())},a.dodataDone=function(){$.blockUI({message:"Update data nilai kelas "+a.datakirim.nama_kelas}),s.post("proktor/kirimnilai/done",a.datakirim,(function(t){t.success?($.unblockUI({}),a.reloadTable(),Swal.fire({type:"success",title:"Berhasil",showConfirmButton:!1,html:"Data Nilai kelas "+a.datakirim.nama_kelas+" berhasil dikirim",timer:2e3})):($.unblockUI({}),Swal.fire({type:"error",title:"Gagal",showConfirmButton:!0,html:t.message}))}))},a.dataPusat=[]}]);
